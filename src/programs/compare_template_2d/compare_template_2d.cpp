...
void CompareTemplate2DApp::DoInteractiveUserInput( ) {
    ...
    my_current_job.ManualSetArguments("tttttffffffffifftiffiiii",
...
bool CompareTemplate2DApp::DoCalculation( ) {
    ...
    int number_of_sampled_views = my_current_job.arguments[22].ReturnIntegerArgument( );
    int result_number           = my_current_job.arguments[23].ReturnIntegerArgument( );
    ...
    for ( int K = 0; K < number_of_sampled_views; K++ ) {
        ...
        angles.Init(phi_tm[k2], theta_tm[k2], psi_tm[k1], 0.0, 0.0);
