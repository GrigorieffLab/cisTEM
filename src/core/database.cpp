...
void Database::AddTemplateMatchingResult(long wanted_template_match_id, TemplateMatchJobResults& job_details) {
    ...
    //, job_details.tip_filename.ToUTF8( ).data( ), job_details.top_psi_filename.ToUTF8( ).data( ), job_details.top_theta_filename.ToUTF8( ).data( ), job_details.top_phi_filename.ToUTF8( ).data( ));
