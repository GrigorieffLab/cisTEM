...
TemplateMatchJobResults Database::GetTemplateMatchingResultByID(long wanted_template_match_id) {
    ...
    temp_result.tip_filename                    = sqlite3_column_text(list_statement, 44);
    temp_result.top_psi_filename                = sqlite3_column_text(list_statement, 45);
    temp_result.top_theta_filename              = sqlite3_column_text(list_statement, 46);
    temp_result.top_phi_filename                = sqlite3_column_text(list_statement, 47);
